...
This project uses Python to provide a GUI and export cheat codes. To run it, you must install Python for your system. The minimum version required is 3.7 at the least.
